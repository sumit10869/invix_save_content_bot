    ...
    for i in range(len(ids)):
        ...
        try: 
            ...
            await countdown.edit(count_down, 
                                 buttons=[[Button.url("Join Channel", url="https://t.me/neetumamvol2")]])
            ...
            if int(fw.value) > 300:
                ...
                try:
                    ...
                    if countdown.text != count_down:
                        await countdown.edit(count_down, buttons=[[Button.url("Join Channel", url="http://t.me/official_satyam01")]])
        except Exception as e:
            #print(e)
            logger.info(e)
            await client.send_message(sender, f"An error occurred during cloning, batch will continue.\n\n**Error:** {str(e)}")
            if countdown.text != count_down:
                await countdown.edit(count_down, buttons=[[Button.url("Join Channel", url="https://t.me/official_satyam01")]])
        n = i + 1
        if n == len(ids):
            return -2
...
TEXT = "👋 Hi, This is '𝐏𝐫𝐢𝐯𝐚𝐭𝐞 𝐕𝐢𝐝𝐞𝐨 𝐒𝐚𝐯𝐞 𝐁𝐨𝐭 🖲️' bot Made with ❤️ by __**๛𝐌𝐑๛𝐒𝐀𝐓𝐘𝐀𝐌๛**__."

@gagan.on(events.NewMessage(pattern=f"^{C}"))
async def start_command(event):
    # Creating inline keyboard with buttons
    buttons = [
        [Button.inline("❤️‍🔥 **STOP** ❤️‍🔥", data="cancel"),
         Button.inline("❤️‍🔥 **STOP** ❤️‍🔥", data="cancel")],
        [Button.url("Join Channel", url="https://telegram.dog/official_satyam01")]
    ]
